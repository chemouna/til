...
- [Functions do not belong to data in clojure](clojure/functions-do-not-belong-to-data-in-clojure.md)
...
- [Pruning stale remote-tracking branches](git/prunning-stale-remote-tracking-branches.md)
...
- [Draw a box with input and output to describe a problem](problemSolving/draw-box-input-output-describe-problem.md)
...
- [Bit tricks](algorithms/bit_tricks.md)
